    ...
    extends AbstractTomcat9Mojo
{
     ...
     */
    private String name = "Custom Apache 9 Tomcat Maven Plugin";
        ...
        throws MojoExecutionException
    {
        ...
        catch ( IOException exception )
        {
            throw new MojoExecutionException( messagesProvider.getMessage( "AbstractCatalinaMojo.managerIOError" ),
                                              exception );
        } catch (CredentialsDataSourceException exception) {
            throw new MojoExecutionException( messagesProvider.getMessage( "AbstractCatalinaMojo.managerError" ) ,
                                              exception );
        }
    }
    ...
    protected abstract void invokeManager()
            throws MojoExecutionException, TomcatManagerException, IOException, CredentialsDataSourceException;
     ...
     * @throws org.apache.maven.artifact.manager.CredentialsDataSourceException
     *          if there was a problem obtaining the authentication details
     */
    protected TomcatManager getManager()
            throws MojoExecutionException, CredentialsDataSourceException {
