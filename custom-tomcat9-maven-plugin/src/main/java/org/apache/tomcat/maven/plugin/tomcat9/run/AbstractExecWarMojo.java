    ...
    extends AbstractTomcat9Mojo
{
     ...
     */
    @Parameter( defaultValue = "${project.build.directory}/custom-tomcat9-maven-plugin-exec" )
        ...
        try
        {
            ...
            for ( Artifact pluginArtifact : pluginArtifacts )
            {
                if ( StringUtils.equals( "org.apache.tomcat", pluginArtifact.getGroupId() ) //
                    ...
                    || StringUtils.equals( "custom-tomcat9-war-runner", pluginArtifact.getArtifactId() ) )
                {
