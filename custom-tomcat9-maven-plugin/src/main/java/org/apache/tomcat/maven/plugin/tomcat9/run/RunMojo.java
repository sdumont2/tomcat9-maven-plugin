        ...
        extends AbstractRunMojo
{
            ...
            throws MojoExecutionException
    {
        ...
        try
        {
            temporaryContextFile = File.createTempFile( "custom-tomcat9-maven-plugin", "temp-ctx-file" );
            ...
            throws MojoExecutionException
    {
        ...
        try
        {
            ...
            final List<String> jarPaths = classLoaderEntries;//extractJars( classLoaderEntries );
                        ...
                        private WebResource urlToWebResource( URL url, String path )
                        {
                            ...
                            try
                            {
                                ...
                                if ( idx >= 0 )
                                {
                                    ...
                                    return new JarResourceSet(context.getResources(), webAppPath, filePath, null).getResource(StringUtils.removeStart( path, "/" ));
                                }
                                else
                                {
                                    return new FileResource( this, webAppPath, new File( filePath ), true,null );
                                }
